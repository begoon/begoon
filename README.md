...
- [rk86-js](https://github.com/begoon/rk86-js) - original emulator running on [rk86.ru/classic](https://rk86.ru/classic) and the next generation emulator toolkit in Svelte/Typescript, running on [rk86.ru](https://rk86.ru) and in terminal via `npx rk86`
...
- [rk86-reversal](https://github.com/begoon/rk86-reversal) - skills для Claude Code для дизассемблирования программ для РК
...
- [Городки](https://github.com/begoon/skittles) - A web reimagining of Городки — the classic arcade and folk game ([play online](https://begoon.github.io/skittles))
